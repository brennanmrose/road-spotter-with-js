...
Category.create(name: 'Stoplights')
...
ReportedIssue.create(chief_complaint: "The crosswalk is broken at this stoplight", transportation_type: 'Other', street_address: '1 S 8th St', locality: 'Philadelphia', region: 'PA', postal_code: '19093', user_id: '1', category_id: '4')